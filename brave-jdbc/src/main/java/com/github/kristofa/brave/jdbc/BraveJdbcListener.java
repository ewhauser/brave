...
public final class BraveJdbcListener extends JdbcEventListener {
    ...
    public BraveJdbcListener(P6BraveOptions options) {
        try {
    ...
    private void startTrace(String sql) {
        ClientTracer clientTracer = BraveJdbcListener.clientTracer;
